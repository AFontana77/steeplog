          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-8">
              ...
              <form className="flex flex-col gap-3" onSubmit={e => e.preventDefault()}>
                ...
                />
                <button type="submit" className="w-full inline-flex items-center justify-center gap-2 bg-emerald-800 text-white font-semibold px-6 py-3 rounded-xl hover:bg-emerald-900 transition-colors press-feedback min-h-[48px]">
